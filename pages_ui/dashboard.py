...
def show():
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    st.markdown('<div class="section-title">Good evening ⚡</div>', unsafe_allow_html=True)
    st.markdown('<div class="section-sub">Your KSEB energy overview</div>', unsafe_allow_html=True)
